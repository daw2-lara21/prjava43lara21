...
public class Prjava43lara21 extends Frame 
   ...
   public Prjava43lara21 () { 
      ...
      setTitle("nova finestra prjava43lara21");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43lara21();  // Let the construct do the job 
   } 
